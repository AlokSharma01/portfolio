				...
				>
					<div className="lcl--content">
						{socialsData.linkedIn && (
							<a
								href="https://www.linkedin.com/in/alok-sharma-6bb305203/"
								target="_blank"
								rel="noreferrer"
							>
								<FaLinkedin
						...
						{socialsData.github && (
							<a
								href="https://github.com/aloksharma01"
								target="_blank"
								rel="noreferrer"
							>
								<FaGithub
						...
						>
							<div style={{ marginBottom: "30px" }}>
								{headerData.resumePdf && (
									<a
										href="https://drive.google.com/file/d/1xPW8B2b8eprVkL2in-D2RAG85xYt5eDw/view?usp=sharing"
										download="resume"
										target="_blank"
										rel="noreferrer"
									>
